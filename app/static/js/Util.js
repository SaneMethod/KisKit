 ...
 *
 * Contains miscellenous functions or plugins that don't belong to a specific class.
 */

/**
 * Cover flow jquery plugin - originally done as a side project, further developed and
 * adapted for use with CrowdEffect.
 *
 * Usage:
